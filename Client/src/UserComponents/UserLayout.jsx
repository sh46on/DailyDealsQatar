/**
 * UserLayout.jsx — Production-grade layout with:
...
const UserNavbar = lazy(() => import("./UserNavbar"));
...
class ContentErrorBoundary extends Component {
  ...
  componentDidCatch(error, info) {
    ...
    console.error("[UserLayout] Child error:", error, info.componentStack);
  }
...
export default function UserLayout({ children }) {
  ...
  const fetchUser = useCallback(async (signal) => {
    try {
      ...
      console.error("[UserLayout] Failed to fetch user:", err);
