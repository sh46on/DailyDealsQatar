...
/* ── Logo ── */
function NavLogo({ settings, loading, t }) {
  if (loading) {
    return (
      <div style={{
  ...
  return (
    <>
      <nav style={{
        ...
        {/*
          Layout strategy: use CSS Grid with 3 equal columns so the pill nav
          is always perfectly centred regardless of whether the left/right
          sides change content (e.g. "Add Your Company" appearing/disappearing).

          [ logo (left) ] [ pill nav (centre) ] [ actions (right) ]

          The "Add Your Company" button uses visibility:hidden when not on
          Offers so it still occupies space — keeping the right column width
          stable and the centre column truly centred at all times.
        */}
        <div style={{
          ...
          {!isMobile && (
            <div style={{
              ...
              justifySelf: 'center',   /* centre within its grid cell */
            }}>
          ...
          <div style={{
            ...
            gap: 8, flexShrink: 0,
            justifyContent: 'flex-end',   /* pin everything to the right edge */
          }}>

            {/* Search bar — desktop, non-marketplace */}
            ...
            {/* Search icon — mobile, non-marketplace */}
            {isMobile && !isMarketplace && (
              <button
                onClick={() => setIsSearchOpen(true)}
                style={{
            ...
            {/*
              Add Your Company — desktop.
              Always rendered; visibility:hidden when not on Offers so the
              right column keeps its width and the pill nav stays centred.
            */}
            {!isMobile && (
              <Link
                to="/companyrequest"
                ...
                style={{
                  ...
                  flexShrink: 0,
                  /* Hide without collapsing — layout stays stable */
        ...
        {isMobile && menuOpen && (
          <div style={{
            borderTop: `1px solid ${t.pillBorder}`,
            ...
            {/* Add Your Company — mobile menu, offers only */}
            {isOffers && (
              <Link
                to="/companyrequest"
                className="nav-add-company"
